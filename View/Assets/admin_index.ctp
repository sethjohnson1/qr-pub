<div class="assets index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('asset_value'); ?></th>
			<th><?php echo $this->Paginator->sort('template_id'); ?></th>
			<th><?php echo $this->Paginator->sort('sortorder'); ?></th>
