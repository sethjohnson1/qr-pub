<div class="preferences index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('name_value'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($preference['Preference']['name']); ?>&nbsp;</td>
		<td><?php echo h($preference['Preference']['name_value']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $preference['Preference']['id']), array(), __('Are you sure you want to delete # %s?', $preference['Preference']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
